/**
 * @preserve  HTML5 & JavaScript Charts - v1.7.0 GA - http://canvasjs.com/
        ...
        function initLabels() {
            ...
            for (j = 0; j < dataPoints.length; j++) {
                ...
                dataPointEO.indexLabelTextBlock = new TextBlock(_this.plotArea.ctx, {
                    ...
                    maxHeight: dataPointEO.indexLabelWrap ? dataPointEO.indexLabelFontSize * 5 : dataPointEO.indexLabelFontSize * 1.5,
    ...
    Axis.prototype.calculateAxisParameters = function () {
        ...
        if (this.type === "axisX") {
            ...
            if (!isFinite(min) && !isFinite(max)) {
                ...
                min = 0;
            } else if (min === 0 && max === 0) {// When all dataPoints are zero
                max += 9;
                min = 0;
